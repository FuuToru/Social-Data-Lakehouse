...
spark.sql(
    "ALTER TABLE delta.`s3a://datalake/deltatables/bitcoin/` SET TBLPROPERTIES(delta.compatibility.symlinkFormatManifest.enabled=true)"
)
spark.sql(
    "CREATE TABLE IF NOT EXISTS delta_bitcoin USING DELTA LOCATION 's3a://datalake/deltatables/bitcoin/'"
)
